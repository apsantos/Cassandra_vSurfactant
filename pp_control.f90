...
SUBROUTINE PP_Control

  !****************************************************************************
  ! Reads in all necessary control variables to run post processing
  !
  ! Called by 
  !
  !   main
...
!*******************************************************************************
  ...
  ! Get transport property info including:
  !         mean-squared displacement info
  CALL Get_Trans_Info
