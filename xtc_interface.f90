...
module xtc_interface

    use, intrinsic :: iso_c_binding, only: C_PTR, C_CHAR, C_FLOAT, C_INT

    implicit none
    private
    public xdrfile_open,xdrfile_close, read_xtc_natoms, read_xtc_c
    ...
    interface 
      ...
      integer(C_INT) function read_xtc_c(xd,NATOMS,STEP,time,box,x,prec) bind(C, name='read_xtc')
        import
